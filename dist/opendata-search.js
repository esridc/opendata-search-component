...
var OpendataSearch = (function (_HTMLElement) {
  ...
  OpendataSearch.prototype.createdCallback = function createdCallback() {
    ...
    if ((0, _utilQueryJs2['default'])('#od_no_results_template', this).length > 0) {
