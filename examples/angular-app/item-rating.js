...
var ItemRating = (function (_HTMLElement) {
  ...
  _createClass(ItemRating, [{
    ...
    value: function updateRating() {
      ...
      (0, _utilQueryJs2['default'])('a', this).forEach(function (star) {
    ...
    value: function updateNumRatings() {
      (0, _utilQueryJs2['default'])('.numRatings', this)[0].innerText = this.numRatings + ' Ratings';
    }
  }, {
    key: 'itemId',
    get: function get() {
